...
public final class ServiceManagerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.api.servicemanagement.v1.EnableServiceRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.google.longrunning.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.api.servicemanagement.v1.EnableServiceRequest,
      com.google.longrunning.Operation> getEnableServiceMethod() {
    io.grpc.MethodDescriptor<com.google.api.servicemanagement.v1.EnableServiceRequest, com.google.longrunning.Operation> getEnableServiceMethod;
    if ((getEnableServiceMethod = ServiceManagerGrpc.getEnableServiceMethod) == null) {
      synchronized (ServiceManagerGrpc.class) {
        if ((getEnableServiceMethod = ServiceManagerGrpc.getEnableServiceMethod) == null) {
          ServiceManagerGrpc.getEnableServiceMethod = getEnableServiceMethod =
              io.grpc.MethodDescriptor.<com.google.api.servicemanagement.v1.EnableServiceRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "EnableService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.api.servicemanagement.v1.EnableServiceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new ServiceManagerMethodDescriptorSupplier("EnableService"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.api.servicemanagement.v1.DisableServiceRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.google.longrunning.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.api.servicemanagement.v1.DisableServiceRequest,
      com.google.longrunning.Operation> getDisableServiceMethod() {
    io.grpc.MethodDescriptor<com.google.api.servicemanagement.v1.DisableServiceRequest, com.google.longrunning.Operation> getDisableServiceMethod;
    if ((getDisableServiceMethod = ServiceManagerGrpc.getDisableServiceMethod) == null) {
      synchronized (ServiceManagerGrpc.class) {
        if ((getDisableServiceMethod = ServiceManagerGrpc.getDisableServiceMethod) == null) {
          ServiceManagerGrpc.getDisableServiceMethod = getDisableServiceMethod =
              io.grpc.MethodDescriptor.<com.google.api.servicemanagement.v1.DisableServiceRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DisableService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.api.servicemanagement.v1.DisableServiceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new ServiceManagerMethodDescriptorSupplier("DisableService"))
              .build();
        }
      }
    }
